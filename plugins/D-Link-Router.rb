...
{ :model=>'di524', :status=>200, :url=>'/html/images/di524.jpg', :certainty=>75 },
{ :model=>'di624', :status=>200, :url=>'/html/images/di624.jpg', :certainty=>75 },
{ :model=>'di624s', :status=>200, :url=>'/html/images/di624s.jpg', :certainty=>75 },
{ :model=>'di724gu', :md5=>"c606bef069437e9472c4bebc81dbee19", :url=>'/html/images/di724gu.jpg' },
{ :model=>'dilb604', :status=>200, :url=>'/html/images/dilb604.jpg', :certainty=>75 },
...
{ :model=>'dir635', :status=>200, :url=>'/html/images/dir635.jpg', :certainty=>75 },
{ :model=>'dir655', :md5=>"62a385cadf77c8630e87060547707eb7", :url=>'/html/images/dir655.jpg' },
{ :model=>'dir660', :status=>200, :url=>'/html/images/dir660.jpg', :certainty=>75 },
{ :model=>'ebr2310', :md5=>"4e62beb3f55fe187b75ef5899a52620f", :url=>'/html/images/ebr2310.jpg' },
{ :model=>'kr1', :status=>200, :url=>'/html/images/kr1.jpg', :certainty=>75 },
{ :model=>'tmg5240', :status=>200, :url=>'/html/images/tmg5240.jpg', :certainty=>75 },
{ :model=>'wbr1310', :status=>200, :url=>'/html/images/wbr1310.jpg', :certainty=>75 },
{ :model=>'wbr2310', :md5=>"30a465c6e71be88eadbe43bed924c02b", :url=>'/html/images/wbr2310.jpg' },
{ :model=>'dsl604', :status=>200, :url=>'/html/images/dsl604.jpg', :certainty=>75 },
...
{ :model=>'dsl302g', :status=>200, :url=>'/html/images/dsl302g.jpg', :certainty=>75 },
{ :model=>'dsl502g', :status=>200, :url=>'/html/images/dsl502g.jpg', :certainty=>75 },
...
{ :model=>'dwl2130ap', :status=>200, :url=>'/html/images/dwl2130ap.jpg', :certainty=>75 },
{ :model=>'dwl2200ap', :status=>200, :url=>'/html/images/dwl2200ap.jpg', :certainty=>75 },
...
{ :model=>'dwl7200ap', :status=>200, :url=>'/html/images/dwl7200ap.jpg', :certainty=>75 },
...
{ :model=>'dwl8220ap', :status=>200, :url=>'/html/images/dwl8220ap.jpg', :certainty=>75 },
{ :model=>'dwlag132', :status=>200, :url=>'/html/images/dwlag132.jpg', :certainty=>75 },
{ :model=>'dwlag530', :status=>200, :url=>'/html/images/dwlag530.jpg', :certainty=>75 },
{ :model=>'dwlag660', :status=>200, :url=>'/html/images/dwlag660.jpg', :certainty=>75 },
{ :model=>'dwlag700ap', :status=>200, :url=>'/html/images/dwlag700ap.jpg', :certainty=>75 },
{ :model=>'dwlg120', :status=>200, :url=>'/html/images/dwlg120.jpg', :certainty=>75 },
{ :model=>'dwlg122', :status=>200, :url=>'/html/images/dwlg122.jpg', :certainty=>75 },
{ :model=>'dwlg132', :status=>200, :url=>'/html/images/dwlg132.jpg', :certainty=>75 },
{ :model=>'dwlg510', :status=>200, :url=>'/html/images/dwlg510.jpg', :certainty=>75 },
{ :model=>'dwlg520', :status=>200, :url=>'/html/images/dwlg520.jpg', :certainty=>75 },
{ :model=>'dwlg520m', :status=>200, :url=>'/html/images/dwlg520m.jpg', :certainty=>75 },
{ :model=>'dwlg550', :status=>200, :url=>'/html/images/dwlg550.jpg', :certainty=>75 },
{ :model=>'dwlg630', :status=>200, :url=>'/html/images/dwlg630.jpg', :certainty=>75 },
{ :model=>'dwlg650', :status=>200, :url=>'/html/images/dwlg650.jpg', :certainty=>75 },
{ :model=>'dwlg650m', :status=>200, :url=>'/html/images/dwlg650m.jpg', :certainty=>75 },
{ :model=>'dwlg680', :status=>200, :url=>'/html/images/dwlg680.jpg', :certainty=>75 },
{ :model=>'dwlg700ap', :md5=>"8e57f557477f898a92643e1a3fbaff06", :url=>'/html/images/dwlg700ap.jpg' },
{ :model=>'dwlg710', :status=>200, :url=>'/html/images/dwlg710.jpg', :certainty=>75 },
{ :model=>'dwlg730ap', :md5=>"3b58bc4790b91d07da3bc47827ccc77c", :url=>'/html/images/dwlg730ap.jpg' },
{ :model=>'dwlg820', :status=>200, :url=>'/html/images/dwlg820.jpg', :certainty=>75 },
...
{ :model=>'wna1330', :status=>200, :url=>'/html/images/wna1330.jpg', :certainty=>75 },
...
{ :model=>'wua2340', :status=>200, :url=>'/html/images/wua2340.jpg', :certainty=>75 },
{ :model=>'DSL502T', :status=>200, :url=>'/html/images/help_p.jpg', :certainty=>75 },
{ :model=>'DSL524T', :status=>200, :url=>'/html/images/device.gif', :certainty=>75 },
