...
matches [
	...
	# Name :
	{ :version=>/<h1><span id="page_displayname_text">([^<]*)<\/span><\/h1>/, :offset=>0 },

	# Photos :
	{ :model=>/<li id="item_view_photos"><a class="icon photos" id="link_view_photos" href="\/photo_gallery.html\?uid=[0-9]*" title="View ([^\"]*)"/, :offset=>0 },

	# Gender :
	{ :string=>/<p><label>Gender:<\/label> <span id="basic_info_genderString">([^<]*)<\/span><\/p>/, :offset=>0, :module=>"Public Profile" },

	# Ethnicity :
	{ :string=>/<p><label>Ethnicity:<\/label> <span id="basic_info_userEthnicities">([^<]*)<\/span><\/p>/, :offset=>0, :module=>"Public Profile" },

	# Religion :
	{ :string=>/<p><label>Religion:<\/label> <span id="basic_info_religion">([^<]*)<\/span><\/p>/, :offset=>0, :module=>"Public Profile" },

	# Orientation :
	{ :string=>/<p><label>Orientation:<\/label> <span id="basic_info_orientation">([^<]*)<\/span><\/p>/, :offset=>0, :module=>"Public Profile" },
