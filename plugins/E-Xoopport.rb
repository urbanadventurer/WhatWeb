...
{ :version=>/<div align='center'>Powered by E-Xoopport ([^&]+)&copy; 2004[\-0-9]{0,5} <a href='http:\/\/www.e-xoopport.it\/' target='_blank'>The E-Xoopport Project<\/a><\/div>/, :offset=>0 },

# Version Detection # Meta generator
{ :version=>/<meta name="generator" content="E-Xoopport ([^"]+)">/, :offset=>0 },
