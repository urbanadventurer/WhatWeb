...
{ :version=>/<meta name="GENERATOR" content="AxCMS.net ver([\d\.]{1,15})">/, :offset=>0 },
{ :version=>/<meta name="GENERATOR" content="AxCMS.net ([\d\.]{1,15})" \/>/, :offset=>0 },

# Version Detection # HTML Comment
{ :version=>/<!-- Generated by AxCMS.net ([\d\.]{1,15}) -->/, :offset=>0 },
