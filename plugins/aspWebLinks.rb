...
{ :version=>/Powered By aspWebLinks ([\d\.]+) from <A[^>]*HREF=["']http:\/\/www.fullrevolution.com[^>]*>Full Revolution, Inc.<\/A>/, :offset=>0 },
{ :version=>/<A[^>]*HREF=["']http:\/\/www.fullrevolution.com[^>]*>Powered By aspWebLinks ([\d\.]+)<\/A>/, :offset=>0 },

# Version detection # Default title
{ :version=>/<title>aspWebLinks ([\d\.]+)<\/title>/, :offset=>0 },
