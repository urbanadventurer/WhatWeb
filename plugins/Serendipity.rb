...
{ :version=>/<meta name="Powered-By" content="Serendipity v.([^"]+)" \/>/i, :regexp_offset=>0 },

# Version Detection # Proudly powered by text
{ :version=>/My weblog is proudly powered by <a href="http:\/\/www.s9y.org">Serendipity ([^<]+)<\/a>.<br \/>/, :regexp_offset=>0 },
