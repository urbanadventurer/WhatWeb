...
version "0.1"
description "EMC NetWorker (formerly Legato NetWorker) centralizes, automates, and accelerates data backup and recovery. - Homepage: http://www.emc.com/domains/legato/index.htm"
