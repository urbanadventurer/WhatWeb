...
{ :version=>/<[script|SCRIPT]+[\ type="text\/javascript"]* src="http:\/\/client.zimplit.com\/users\/publicUser_v([\d\._]+)\/[jquery.js|ZimgZoomer.js|ZZMenu.js]+"[\ type="text\/javascript"]*><\/[script|SCRIPT]+>/, :offset=>0 },
