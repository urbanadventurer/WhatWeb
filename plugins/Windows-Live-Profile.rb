...
matches [
	...
	# Name :
	{ :version=>/<span  id="ic3" class="c_ic_i"><span  class="c_ic_name" id="ic3_name" title="([^\"]*)">/, :offset=>0, :url=>"/details" },
	{ :version=>/<div  id="ic[0-9]+"  class="c_ic c_ic_h_xl"><div class="c_ic_img_h c_ic_img_xl"><div class="c_ic_img_sub c_ic_img_xl" id="ic[0-9]+_usertilecontainer"><a  id="ic2_frame_clip" title="Picture of ([^\"]+)" class="c_ic_frame_clip c_ml" target="_top" href="/, :offset=>0 },

	# Friends
	{ :filepath=>/<div class="L_FloatLeft frex_friend"><div  id="ic[0-9]+"  class="c_ic c_ic_v_m_t"><div class="c_ic_img_v c_ic_img_m"><div class="c_ic_img_sub c_ic_img_m" id="ic[0-9]+_usertilecontainer"><a  id="ic[0-9]+_frame_clip" title="Picture of ([^\"]*)" class="c_ic_frame_clip c_ml" target="_top" href="/, :offset=>0 },

	# Birthday :
	{ :model=>/<div class="sn_aboutme_heading" >Birthday<\/div><div class="sn_aboutme_text sn_aboutme_textOverflow" title="">([^<]*)<\/div>/, :offset=>0 },

	# Interests :
	{ :string=>/Interests&#58;[\W]*<\/td>[\W]*<td id="intVal" class="cd_value cd_rowElementPadding">[\W]*([^<^\r^\n]*)[\W]*<\/td>/, :offset=>0, :url=>"/details" },
