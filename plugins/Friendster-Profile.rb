...
matches [
	...
	# Name
	{ :version=>/<title>Friendster - ([^<]*)<\/title><meta name="description" content="/, :offset=>0 },

	# Keywords
	{ :string=>/<meta name="keywords" content="Friendster profile,([^\"]+)">/, :offset=>0 },

	# Friends :
	{ :filepath=>/<div class="friendName"><a href="http:\/\/profiles.friendster.com\/[^>]*">([^<]*)<\/a><\/div>/, :offset=>0 },
