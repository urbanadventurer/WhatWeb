...
{:version=>/<meta name="generator" content="AWStats ([0-9\.]+ \(build [0-9\.]+\))/, :offset=>0}, #" good for 6.7
{:version=>/<FONT COLOR="#000000"><b>Advanced Web Statistics ([0-9\.]+ \(build [0-9\.]+\))/, :offset=>0},

{:url=>'awstats.pl?framename=mainright', :version=>/<FONT COLOR="#000000"><b>Advanced Web Statistics ([0-9\.]+ \(build [0-9\.]+\))/, :offset=>0}
]
