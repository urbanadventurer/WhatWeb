...
{ :version=>/			<p>Powered by <a href="http:\/\/www.openautoclassifieds.com[^"]*">Open Auto Classifieds v([\d\.a-z]+)/, :regexp_offset=>0 },

# Version Detection # Powered by text
{ :version=>/			<p>Powered by Open Auto Classifieds v([\d\.a-z]+)/, :regexp_offset=>0 },
